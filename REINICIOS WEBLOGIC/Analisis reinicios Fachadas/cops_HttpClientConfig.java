package com.citibanamex.cops.configuration;

import com.citibanamex.cops.dao.ClientParams;
import com.citibanamex.cops.service.SessionParamsProvider;
import com.citibanamex.cops.ws.client.KeepAliveStrategy;
import com.citibanamex.cops.ws.utils.KeyStoreHelper;
...
public class HttpClientConfig implements DisposableBean {
    ...
    protected SSLConnectionSocketFactory sslConnectionSocketFactory() {
        ClientParams clientParams = paramsProvider.getCacheParameters();
        try {
            return new SSLConnectionSocketFactory(KeyStoreHelper.getSslSocketFactory(
    ...
    public CloseableHttpClient closeableHttpClient(RequestConfig requestConfig,
        ...
        CloseableHttpClient httpClient = HttpClients.custom()
                ...
                .setMaxConnPerRoute(clientParams.getMaxTotal())
                .setMaxConnTotal(clientParams.getMaxTotal())
                .build();
    ...
    public TaskScheduler taskScheduler() {
        ...
        scheduler.setThreadNamePrefix("cops-pool-");
        ...
        return new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    log.debug("AO-COPS HTTP POOL → leased: {}, available: {}, pending: {}, max: {}",
    ...
    public void destroy() {
        try {
            if (closeableHttpClientRef != null) {
                ...
                log.info("CloseableHttpClient cerrado correctamente en shutdown de COPS");
            }
        } catch (IOException e) {
            log.warn("No se pudo cerrar CloseableHttpClient en shutdown de COPS: {}", e.getMessage());
        } finally {
